  ...
  <div>
    ...
    >
      <n-descriptions label-placement="left" class="py-2">
        ...
        <n-descriptions-item label="收款账户">MediaManagerAdmin@qq.com</n-descriptions-item>
        <n-descriptions-item label="付款类型">支付宝</n-descriptions-item>
        <n-descriptions-item label="付款账户">MediaManagerAdmin@163.com</n-descriptions-item>
    ...
    >
      <n-descriptions label-placement="left" class="py-2">
        ...
        <n-descriptions-item label="邮箱">MediaManagerAdmin@qq.com</n-descriptions-item>
